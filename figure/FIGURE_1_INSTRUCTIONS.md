# Figure 1: System Architecture Diagram - Creation Instructions
...
- **Question Generator** (Right of LLM, light red/pink box)
...
11. Vector Store → Question Generator (down arrow)
12. Answer + Citations → Web Interface (right arrow)
13. Question Generator → Web Interface (right arrow)
...
- **Light Red/Pink**: Generation (RAG System, LLM, Question Generator)
...
- Save as: `figure_1_system_architecture.png`
...
3. Select `figure_1_system_architecture_drawio.xml`
4. Edit as needed
5. Export as PNG
...
graph TD
    ...
    E --> L[Question Generator<br/>GPT-4o]
    L --> M[Multiple Choice Questions]
    K --> N[Web Interface]
    M --> N
```
